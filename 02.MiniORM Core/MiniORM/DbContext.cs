    ...
    public abstract class DbContext
    {
        ...
        private void InitializeDbSets()
        {
            foreach (var dbSet in this.dbSetProperties)
            {
                ...
                populateDbSetGeneric.Invoke(this.connection, new object[] {dbSetProperty});
            }
        }
        ...
        private void PopulateDbSet<TEntity>(PropertyInfo dbSet)
            where TEntity:class, new()
        {
            IEnumerable<TEntity> entities = (IEnumerable<TEntity>) LoadTableEntities<TEntity>();
        ...
        private object LoadTableEntities<TEntity>() 
            where TEntity : class, new()
        {
